...
# provide implementation of Javascript client for Elastic Search supporting jQuery and Node.js clients (basic jQuery support is already implemented).
# provide NodeJS based proxy server for Elastic Search (almost complete now).

h2. Simple example of Javascript client
...
h2. Proxy server example

See "node":http://github.com/lukas-vlcek/elasticsearch-js/tree/master/js/node/ folder for sources (documentation can be found in source files).
