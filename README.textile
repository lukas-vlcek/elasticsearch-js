...
The proxy server is written in NodeJS. See "node":http://github.com/lukas-vlcek/elasticsearch-js/tree/master/js/node/ folder for sources (detailed documentation can be found in source file: "elasticsearch-proxy.js":http://github.com/lukas-vlcek/elasticsearch-js/blob/master/js/node/elasticsearch-proxy.js).
